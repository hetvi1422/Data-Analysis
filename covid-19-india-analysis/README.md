...
## 📌 Overview
This project performs an **Exploratory Data Analysis (EDA)** on the COVID-19 India dataset to understand the **spread, impact, and recovery trends** across different Indian states and over time.  
...
- **Link:** [COVID-19 in India Dataset](https://www.kaggle.com/datasets/sudalairajkumar/covid19-in-india)  
...
- ⚠️ **Identification of the most affected state**  
...
- ☠️ **Death rate analysis by state**  
- 💚 **Recovery rate analysis by state**  
- ⚖️ **Recovery vs Death comparison (visualized)**  
...
- 💚 Recovery cases were consistently **higher than death cases** across most states  
- ⚠️ Active case analysis highlighted **periods of maximum healthcare burden**  
